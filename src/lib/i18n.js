...
const translations = {
  fr: {
    ...
    "polls.subtitle": "Prenez des décisions ensemble",
    "polls.create": "Nouveau sondage",
    "polls.createDesc": "Posez une question aux membres du voyage.",
    "polls.question": "Question",
    "polls.questionPlaceholder": "Ex: Quelle destination pour le week-end ?",
    "polls.description": "Description (optionnel)",
    "polls.descPlaceholder": "Plus de détails sur le choix...",
    "polls.options": "Options",
    "polls.option": "Option",
    "polls.addOption": "Ajouter une option",
    "polls.deadlineDate": "Date limite (optionnel)",
    "polls.deadlineTime": "Heure",
    "polls.emptyTitle": "Aucun sondage",
    "polls.emptyDesc": "Créez un sondage pour demander l'avis des autres membres du voyage.",
    "polls.createdBy": "Par",
    "polls.votesCount": "votes",
    "polls.ended": "Terminé le",
    "polls.ends": "Se termine le",

    // Photos
    "photos.title": "Galerie Photos",
    "photos.subtitle": "Partagez vos souvenirs de voyage",
    "photos.upload": "Ajouter des photos",
    "photos.emptyTitle": "Aucune photo",
    "photos.emptyDesc": "Commencez à ajouter des photos pour créer votre album de souvenirs.",
    "photos.dragDrop": "Cliquez pour sélectionner une image",
    "photos.caption": "Légende (optionnel)",
    "photos.captionPlaceholder": "Un petit mot sur cette photo...",
    "photos.uploadBtn": "Uploader",
    "photos.by": "Par",
  ...
  en: {
    ...
    // Polls
    "polls.title": "Polls",
    "polls.subtitle": "Make decisions together",
    "polls.create": "New poll",
    "polls.createDesc": "Ask a question to the trip members.",
    "polls.question": "Question",
    "polls.questionPlaceholder": "Ex: Where to go for the weekend?",
    "polls.description": "Description (optional)",
    "polls.descPlaceholder": "More details about the choice...",
    "polls.options": "Options",
    "polls.option": "Option",
    "polls.addOption": "Add an option",
    "polls.deadlineDate": "Deadline date (optional)",
    "polls.deadlineTime": "Time",
    "polls.emptyTitle": "No polls",
    "polls.emptyDesc": "Create a poll to ask the opinion of other trip members.",
    "polls.createdBy": "By",
    "polls.votesCount": "votes",
    "polls.ended": "Ended on",
    "polls.ends": "Ends on",

    // Photos
    "photos.title": "Photo Gallery",
    "photos.subtitle": "Share your travel memories",
    "photos.upload": "Add photos",
    "photos.emptyTitle": "No photos",
    "photos.emptyDesc": "Start adding photos to create your memory album.",
    "photos.dragDrop": "Click to select an image",
    "photos.caption": "Caption (optional)",
    "photos.captionPlaceholder": "A few words about this photo...",
